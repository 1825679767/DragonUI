...
if type(dwGetglobal) ~= "function" then
...
function TradeskillInfo_CreateButton()
	if OpenTradesillInfoButton or not TradeSkillFrame or not TradeSkillRankFrame or not TradeSkillFrameEditBox then
		return
	end
