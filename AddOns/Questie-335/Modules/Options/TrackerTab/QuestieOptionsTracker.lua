    ...
    trackerOptions = {
        ...
        args = {
            ...
            enableQuestieTracker = {
                ...
                desc = function()
                    if Questie.IsDragonUITrackerForced and Questie:IsDragonUITrackerForced() then
                        return "DragonUI manages the quest tracker in this integration. Questie map notes, tooltips, search, and journey features remain available."
                    end
                ...
                disabled = function()
                    return InCombatLockdown() or (Questie.IsDragonUITrackerForced and Questie:IsDragonUITrackerForced())
                end,
