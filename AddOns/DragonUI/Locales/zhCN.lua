...
L["Open plugin management"] = "打开插件管理"
...
L["Move the loot window to your cursor and optionally hide it when there is nothing to loot."] = "将拾取窗口移动到鼠标位置，并可在没有可拾取物品时自动隐藏。"
...
L["Sort Bags"] = "整理背包"
L["Quick Chat Custom 1"] = "综"
L["Quick Chat Say"] = "说"
L["Quick Chat Yell"] = "喊"
L["Quick Chat Reply"] = "回"
L["Quick Chat Guild"] = "会"
L["Quick Chat Party"] = "队"
L["Quick Chat Raid"] = "团"
L["Quick Chat Raid Warning"] = "警"
L["Quick Chat Battleground"] = "战"
L["Sort Bank"] = "整理银行"
L["Sort Items"] = "整理物品"
...
L["Merchant Enhancements"] = "商人增强"
L["Automatic repairs and an expanded merchant list layout."] = "自动修理并扩展商人商品列表布局。"
L["Repair Cost"] = "修理费用"
L["No Repairs Needed"] = "无需修理"
L["Auto-repaired for %s."] = "已自动修理，花费：%s。"
L["Auto-repaired using guild bank funds for %s."] = "已使用公会银行资金自动修理，花费：%s。"
L["Not enough money to repair equipment."] = "金币不足，无法修理装备。"
L["Key Binding"] = "按键绑定"
