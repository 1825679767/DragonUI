...
L["Automatic repairs and an expanded merchant list layout."] = true
L["Repair Cost"] = true
L["No Repairs Needed"] = true
L["Auto-repaired for %s."] = true
L["Auto-repaired using guild bank funds for %s."] = true
L["Not enough money to repair equipment."] = true
L["Key Binding"] = true
