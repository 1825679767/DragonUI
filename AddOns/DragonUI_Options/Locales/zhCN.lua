...
L["Plugin Management"] = "插件管理"
L["Interface Configuration"] = "界面配置"
L["This area is reserved for future integrated addon settings."] = "这个区域预留给后续整合插件的设置。"
L["When DragonUI integrates external addons, their options will appear here."] = "后续当 DragonUI 整合外部插件后，对应的配置会显示在这里。"
L["Manage integrated addons here. You can enable them, disable them, and open their own configuration panels."] = "你可以在这里管理整合插件，包括启用、禁用，以及打开它们自己的配置界面。"
L["Categories"] = "分类"
L["Name"] = "名称"
L["Description"] = "说明"
L["Action"] = "操作"
L["Encounter Tools"] = "首领战斗"
L["Interface Enhancements"] = "界面增强"
L["Raid Frames"] = "团队框架"
L["Utilities"] = "实用工具"
L["Combat Statistics"] = "战斗统计"
L["No integrated addons in this category yet."] = "这个分类下暂时还没有整合插件。"
L["Boss encounter warnings and timers."] = "首领战报警与技能计时。"
L["Enhanced enemy and friendly nameplates."] = "增强敌对与友方姓名板显示。"
L["Modular party and raid unit frames for healing and group visibility."] = "模块化的小队与团队框架，适合治疗和团队信息观察。"
L["Automatically sells junk items and manages keep/sell exception lists."] = "自动出售垃圾物品，并管理保留/出售的例外列表。"
L["Damage, healing, threat, and combat statistics."] = "伤害、治疗、仇恨和战斗统计。"
L["Status"] = "状态"
L["Not installed"] = "未安装"
L["Disabled"] = "已禁用"
L["Loaded"] = "已加载"
L["Needs Reload"] = "需重载"
L["Enabled, requires reload if not already loaded."] = "已启用，若当前尚未加载则需要重载界面。"
L["Enable plugin"] = "启用插件"
L["Settings"] = "设置"
L["Turn this integrated addon on or off for the current character."] = "为当前角色启用或禁用这个整合插件。"
L["Open settings"] = "打开设置"
L["Open this addon's own configuration window."] = "打开该插件自己的配置窗口。"
L["Refresh status"] = "刷新状态"
L["Refresh this plugin's state in the management panel."] = "刷新这个插件在管理面板中的状态。"
L["This plugin is currently disabled. Enable it first and reload the UI."] = "这个插件当前已被禁用，请先启用并重载界面。"
L["This plugin is not loaded yet. Reload the UI first, then try again."] = "这个插件当前还没有加载，请先重载界面再试。"
L["DBM consists of the core, GUI, and multiple raid/party modules that are managed together."] = "DBM 由核心、图形界面以及多个团队/副本模块组成，这里会统一管理。"
