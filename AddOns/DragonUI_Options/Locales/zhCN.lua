...
L["Group & Healing"] = "团队与治疗"
L["PvP Tools"] = "PvP 工具"
L["Reference & Gathering"] = "资料与采集"
...
L["Raid and party alert announcer for tank danger, threat, crowd control breaks, misdirects, dispels, and raid checks."] = "团队与小队报警工具，可提示坦克危险、仇恨、破控、误导、驱散以及团队检查等信息。"
L["Quest helper with map notes, minimap objectives, tooltips, search, journey log, and its own quest tracker."] = "任务辅助插件，提供地图标记、小地图目标、鼠标提示、搜索、旅程记录以及独立任务追踪器。"
L["Questie uses DragonUI's quest tracker styling in this integration. Its own tracker is kept disabled while map notes and other quest features remain available."] = "这套整合中，Questie 会使用 DragonUI 的任务追踪样式。Questie 自带追踪器会保持关闭，但地图标记等任务功能仍然可用。"
...
L["Click-casting bindings that pair especially well with Grid2 and healing setups."] = "点击施法绑定，和 Grid2、治疗配置搭配很好。"
L["One-click dispel assistance with priority and debuff list tools."] = "一键驱散辅助，支持优先级和减益列表。"
L["Raid tools for ready checks, durability, cooldowns, loot, and tank assignments."] = "团队工具，包含就绪确认、耐久检查、冷却监控、分配拾取和坦克管理。"
L["Spoken PvP alerts for arena and battleground abilities."] = "为竞技场和战场技能提供语音提醒。"
L["Loot, crafting, faction, and event reward browser with bundled expansion data modules."] = "查询掉落、制造、阵营和活动奖励，并整合多个资料模块。"
L["Dungeon and raid map browser that lets AtlasLoot show drops directly inside instance maps."] = "副本与团队地图浏览器，可让 AtlasLoot 直接在副本地图里显示对应掉落。"
L["Comprehensive profession database with recipe sources, materials, search, and who-can-learn tracking."] = "完整的专业技能资料库，支持配方来源、材料查询、搜索以及角色可学习追踪。"
...
L["Custom spell proc, buff, and target debuff alerts with per-spell lists."] = "自定义法术触发、增益和目标减益提醒，并支持按法术维护监视列表。"
...
L["Clique relies on the spellbook window. The spellbook is now opened for you; click Settings again if the panel still does not appear."] = "Clique 依赖法术书窗口。我已经帮你打开法术书了，如果面板还没出现，再点一次设置即可。"
...
L["Atlas map modules are bundled together so instance, battleground, transport, and outdoor raid maps stay in sync."] = "Atlas 的地图模块会统一管理，这样副本、战场、交通和户外团队地图都能一起工作。"
L["Open the Atlas map browser. AtlasLoot can hook into Atlas to show boss loot directly on these maps."] = "打开 Atlas 地图浏览器。AtlasLoot 可以挂接到 Atlas 上，在这些副本地图里直接显示首领掉落。"
...
L["Enable Quick Loot"] = "启用快速拾取"
L["Move the loot window to your cursor and optionally hide it when there is nothing to loot."] = "将拾取窗口移动到鼠标位置，并可在没有可拾取物品时自动隐藏。"
L["Reposition the loot window at your cursor whenever loot opens or updates."] = "在拾取窗口打开或更新时，把它移动到鼠标位置。"
L["Auto-Hide Empty Loot"] = "自动隐藏空拾取窗口"
L["Hide the loot window automatically if nothing remains to be looted."] = "当已经没有可拾取物品时，自动隐藏拾取窗口。"
...
L["Equipment Durability"] = "装备耐久"
L["Show durability text on equipped gear in the character window and display total repair cost."] = "在角色窗口的已装备物品上显示耐久文字，并显示总修理费用。"
L["Show Durability Text"] = "显示耐久文字"
L["Display durability text on equipment slots in the character window."] = "在角色窗口的装备栏位上显示耐久文字。"
L["Use Percentage Text"] = "使用百分比显示"
L["Show durability as a percentage instead of current/max values."] = "以百分比显示耐久，而不是当前值/最大值。"
L["Show At Full Durability"] = "满耐久时也显示"
L["Keep durability text visible even when an item is fully repaired."] = "即使物品已完全修好，也保持显示耐久文字。"
L["Show Repair Cost"] = "显示修理费用"
L["Display total repair cost in the character window."] = "在角色窗口中显示总修理费用。"
L["Merchant Enhancements"] = "商人增强"
L["Improves the merchant window with automatic repairs and a larger item list layout."] = "增强商人窗口，提供自动修理和更大的商品列表布局。"
L["Enable Merchant Enhancements"] = "启用商人增强"
L["Expand the merchant item list and enable related quality-of-life improvements."] = "扩展商人商品列表，并启用相关便利功能。"
L["Automatic Repairs"] = "自动修理"
L["Automatically repair gear when visiting a merchant who can repair."] = "访问可修理装备的商人时自动修理装备。"
L["Prefer Guild Bank Repairs"] = "优先使用公会银行修理"
L["Use guild bank repair funds first when the merchant allows it."] = "当商人允许时，优先使用公会银行资金进行修理。"
L["Expanded Merchant Layout"] = "扩展商人布局"
L["Show up to 20 merchant items per page in a wider multi-column layout."] = "在更宽的多列布局中，每页最多显示20个商人物品。"
L["Poor"] = "粗糙"
L["Common"] = "普通"
L["Uncommon"] = "优秀"
L["Rare"] = "精良"
