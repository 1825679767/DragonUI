...
L["Plugin Management"] = true
L["Interface Configuration"] = true
L["This area is reserved for future integrated addon settings."] = true
L["When DragonUI integrates external addons, their options will appear here."] = true
L["Manage integrated addons here. You can enable them, disable them, and open their own configuration panels."] = true
L["Categories"] = true
L["Name"] = true
L["Description"] = true
L["Action"] = true
L["Encounter Tools"] = true
L["Group & Healing"] = true
L["PvP Tools"] = true
L["Reference & Gathering"] = true
L["Interface Enhancements"] = true
L["Raid Frames"] = true
L["Utilities"] = true
...
L["Quest helper with map notes, minimap objectives, tooltips, search, journey log, and its own quest tracker."] = true
L["Questie uses DragonUI's quest tracker styling in this integration. Its own tracker is kept disabled while map notes and other quest features remain available."] = true
...
L["One-click dispel assistance with priority and debuff list tools."] = true
...
L["Damage, healing, threat, and combat statistics."] = true
L["Status"] = true
L["Not installed"] = true
L["Disabled"] = true
L["Loaded"] = true
L["Needs Reload"] = true
L["Enabled, requires reload if not already loaded."] = true
L["Enable plugin"] = true
L["Settings"] = true
L["Turn this integrated addon on or off for the current character."] = true
L["Open settings"] = true
L["Open this addon's own configuration window."] = true
L["Refresh status"] = true
L["Refresh this plugin's state in the management panel."] = true
L["This plugin is currently disabled. Enable it first and reload the UI."] = true
L["This plugin is not loaded yet. Reload the UI first, then try again."] = true
L["Clique relies on the spellbook window. The spellbook is now opened for you; click Settings again if the panel still does not appear."] = true
