...
DBM_CORE_NEED_SUPPORT				= "糊涂虫带你装逼带你飞。"
DBM_HOW_TO_USE_MOD					= "欢迎使用DBM。在聊天框输入 /dbm 就可以打开设定面板进行设置。手动载入不同副本模块就可以根据你自己的喜好来调整每个首领的相关报警设定。如果这个你都不会，那你还能做什么？"

DBM_CORE_LOAD_MOD_ERROR				= "读取%s模块时发生错误：%s"
DBM_CORE_LOAD_MOD_SUCCESS			= "成功读取%s模块，不要怂，糊涂虫带你装逼带你飞！"
